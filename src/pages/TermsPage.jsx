...
const TermsPage = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: `The Service is a platform designed to help users manage multi-platform video distribution across YouTube, Facebook, Instagram, and TikTok. Features may include, depending on your subscription plan:\n* Connecting social media accounts via OAuth (YouTube, Facebook, Instagram, TikTok).\n* Uploading videos to one or more connected platforms simultaneously.\n* Creating, saving, and applying metadata templates (titles, descriptions, tags, etc.).\n* Scheduling video uploads with per-platform timing.\n* Client-side video optimization for efficient uploads.\n* Monitoring upload status and viewing history in real-time.\n* Accessing an AI Assistant (Firdha AI, powered by Google Gemini) for support.\n* Utilizing a Live Chat feature for direct administrator support.\n* Potential API access for programmatic use (typically on higher-tier plans).`
    },
    {
